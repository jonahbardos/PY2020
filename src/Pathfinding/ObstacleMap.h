...
private:
	...
	// direction indicates +/- for rounding up or down to the nearest index, true is plus,
	// false is -
...
public:
	// clears the obstacle map and plots a new set of obstacles around the robot's current
	// location
