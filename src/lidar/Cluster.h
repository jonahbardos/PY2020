...
clusterPoints(std::vector<std::shared_ptr<PointXY>> points, float sep_threshold);
std::vector<std::shared_ptr<PointXY>>
convertFrame(std::vector<std::shared_ptr<Polar2D>> frame);
